...
Page({
  ...
  onLoad() {
    this.setData({
      ...
      borderPic:'../../images/ah1.png'
    });
    app.globalData.toubgsrc=this.data.borderPic;
  },
  ...
  chooseCoverImg(e){
    console.log(e);
    this.setData({
      borderPic: e.target.dataset.cover,
    });
    app.globalData.toubgsrc = e.target.dataset.cover;
  },
  chooseImg(e) {
    console.log(e);
    this.setData({
